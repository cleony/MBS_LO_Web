...
Public Class rptlo3_5
    ...
    Protected Sub showreport(sender As Object, e As EventArgs)
        GetDate()
        Session("formname") = "lorpt035"
        If optDate.Value = "ทั้งหมด" Then
            Session("lorpt035_optDate") = "1"
        ElseIf optDate.Value = "ณ วันที่" Then
        ...
        If ddlTypeLoan.SelectedIndex > 0 Then
            ...
            Session("lorpt035_TypeLoanName1") = ddlTypeLoan.SelectedItem.Text
        Else
            Session("lorpt035_TypeLoanId1") = ""
            Session("lorpt035_TypeLoanName1") = "ทั้งหมด"
        End If
        If ddlTypeLoan2.SelectedIndex > 0 Then
            Session("lorpt035_TypeLoanId2") = ddlTypeLoan2.SelectedValue.ToString
            Session("lorpt035_TypeLoanName2") = ddlTypeLoan2.SelectedItem.Text
        Else
            Session("lorpt035_TypeLoanId2") = ""
            Session("lorpt035_TypeLoanName2") = "ทั้งหมด"
        End If
        Session("lorpt035_RptDate") = Share.FormatDate(dtRptDate.Value)
        Session("lorpt035_StDate") = Share.FormatDate(StDate)
        Session("lorpt035_EndDate") = Share.FormatDate(EndDate)
        Session("lorpt035_Year") = Share.FormatString(cboYear.Value)
        Session("lorpt035_Month") = Share.FormatString(SMonth)
        Session("lorpt035_PersonId1") = txtPersonId.Value
        Session("lorpt035_PersonId2") = txtPersonId2.Value
        ...
        Session("lorpt035_branchid") = BranchId
        Session("lorpt035_branchid2") = BranchId2
