...
Public Class rptlo1_4
    ...
    Protected Sub showreport(sender As Object, e As EventArgs)
        Session("formname") = "lorpt014"
        'Session("lorpt001_accountno") = txtAccountNo.Value
        Session("lorpt014_PersonId1") = txtPersonId.Value
        Session("lorpt014_PersonId2") = txtPersonId2.Value
        ...
        Session("lorpt014_branchid") = BranchId
        Session("lorpt014_branchid2") = BranchId2
