...
Public Class rptlo2_3
    ...
    Protected Sub showreport(sender As Object, e As EventArgs)
        GetDate()
        Session("formname") = "lorpt023"
        If ddlTypeLoan.SelectedIndex > 0 Then
            Session("lorpt023_TypeLoanId1") = ddlTypeLoan.SelectedValue.ToString
            Session("lorpt023_TypeLoanName1") = ddlTypeLoan.SelectedItem.Text
        Else
            Session("lorpt023_TypeLoanId1") = ""
            Session("lorpt023_TypeLoanName1") = "ทั้งหมด"
        End If
        If ddlTypeLoan2.SelectedIndex > 0 Then
            Session("lorpt023_TypeLoanId2") = ddlTypeLoan2.SelectedValue.ToString
            Session("lorpt023_TypeLoanName2") = ddlTypeLoan2.SelectedItem.Text
        Else
            Session("lorpt023_TypeLoanId2") = ""
            Session("lorpt023_TypeLoanName2") = "ทั้งหมด"
        End If
        Session("lorpt023_StDate") = Share.FormatDate(StDate)
        Session("lorpt023_EndDate") = Share.FormatDate(EndDate)
        Session("lorpt023_Year") = Share.FormatString(cboYear.Value)
        Session("lorpt023_Month") = Share.FormatString(SMonth)
        ...
        Session("lorpt023_branchid") = BranchId
        Session("lorpt023_branchid2") = BranchId2
