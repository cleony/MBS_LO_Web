<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/backend/Site1.Master" CodeBehind="rptlo2_2.aspx.vb" Inherits="MBS_Loan.rptlo2_2" %>
        ...
        <section class="content">
            <div class="box box-default">
                <div class="box-header with-border">
                    <h3 class="box-title">2.2 รายงานสรุปการชำระเงินกู้ตามสัญญากู้</h3>
                </div>
                <div class="box-body">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="row">
                                            <div class="col-md-4">
                                                ...
                                                <div class="checkbox checkbox-primary">
                                                    <asp:CheckBox ID="ckSt3" runat="server" Text="ปิดบัญชี" class="checkbox-inline" />
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="checkbox checkbox-primary">
                                                    <asp:CheckBox ID="ckSt5" runat="server" Text="ปิดบัญชี(ต่อสัญญาใหม่)" class="checkbox-inline" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <select id="optReport" runat="server" class="custom-select form-control">
                                                ...
                                                <option>แบบสรุป</option>
                                                <option>แบบละเอียดแจงค่าธรรมเนียม</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
