<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/backend/Site1.Master" CodeBehind="rptlo2_6.aspx.vb" Inherits="MBS_Loan.rptlo2_6" %>
        ...
        <section class="content">
            <div class="box box-default">
                <div class="box-header with-border">
                    <h3 class="box-title">2.6 รายงานเฉลี่ยคืนดอกเบี้ยเงินกู้</h3>
                </div>
                <div class="box-body">
                        ...
                        <div class="row">
                            <div class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">อัตราเงินเฉลี่ยคืน</label>
                                        <div class="col-sm-2">
                                            <input type="text" class="form-control number text-right" value="0.00" id="txtDividendRate" runat="server" />
                                        </div>
                                        <label class="col-sm-0 control-label">%</label>
                                    </div>
                                </div>
