<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/backend/Site1.Master" CodeBehind="rptlo3_6.aspx.vb" Inherits="MBS_Loan.rptlo3_6" %>
        ...
        <section class="content">
            <div class="box box-default">
                <div class="box-header with-border">
                    <h3 class="box-title">3.6 รายงานดอกเบี้ยหยุดรับรู้</h3>
                </div>
                <div class="box-body">
