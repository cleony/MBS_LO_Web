<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/backend/Site1.Master" CodeBehind="rptlo3_1.aspx.vb" Inherits="MBS_Loan.rptlo3_1" %>
        ...
        <section class="content">
            <div class="box box-default">
                <div class="box-header with-border">
                    <h3 class="box-title">3.1 รายงานลูกหนี้ค้างชำระเงิน</h3>
                </div>
                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <select id="optReport" runat="server" class="custom-select form-control">
                                                <option>สรุปตามสัญญา</option>
                                                <option>สรุปตามลูกค้า</option>
                                                <option>สรุปตามลูกหนี้ประจำเดือน</option>
                                                <option>สรุปตามดอกเบี้ยรายวัน</option>
                                                <option>สรุปตามงวดคงค้าง</option>
                                                <option>สรุปค้างชำระตามจริง</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
