<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/backend/Site1.Master" CodeBehind="loancfpay.aspx.vb" Inherits="MBS_Loan.loancfpay" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <section class="content">
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">อนุมัติสัญญาโอนเงินกู้</h3>
                </div>
                <div class="box-body">
                    <div class="panel">
                    ...
                    <div class="panel">
                        <div class="panel-body">
                            ...
                            <span class=" text-red" style="display: none" id="lblnotfound" runat="server">ไม่พบสัญญาที่รอการอนุมัติโอนเงินกู้่</span>
                            ...
                            <div class="panel-body form-horizontal">
                                <div id="gbForm" runat="server" style="display: none">
                                    <label class="col-sm-1 control-label ">ฟอร์ม</label>
                                    <div class="col-sm-4">
                                        <asp:DropDownList ID="ddlPrint" runat="server" class="form-control"></asp:DropDownList>
                                    </div>
                                </div>
                                ...
                                <div class="modal-dialog ">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title">อนุมัติโอนเงินกู้</h4>
                                        </div>
                                        <div class="modal-body">
                                            <div class="row">
                                                <%--  <div class="form-group">
                                                    <label class="col-sm-5">วันที่อนุมัติ</label>
                                                    <div class="col-sm-5">
                                                        <div class="input-prepend input-group">
                                                            <span class="add-on input-group-addon">
                                                                <i class="glyph-icon icon-calendar"></i>
                                                            </span>
                                                            <input type="text" id="dtCFLoanDate" runat="server" class="bootstrap-datepicker form-control" data-date-format="dd/mm/yyyy" disabled="disabled" />
                                                        </div>
                                                    </div>
                                                </div>--%>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-5">
                                                        <div class="input-prepend input-group">
                                                            ...
                                                            <input type="text" id="dtCFDate" runat="server" class="bootstrap-datepicker form-control" data-date-format="dd/mm/yyyy" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-5">
                                                        <div class="input-prepend input-group">
                                                            ...
                                                            <input type="text" id="dtSTCalDate" runat="server" class="bootstrap-datepicker form-control" data-date-format="dd/mm/yyyy" />
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-5">
                                                        <div class="input-prepend input-group">
                                                            ...
                                                            <input type="text" id="dtSTPayDate" runat="server" class="bootstrap-datepicker form-control" data-date-format="dd/mm/yyyy" />
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <label class="col-sm-5 control-label">จ่ายเงินโดย</label>
                                                    <div class="col-sm-5">
                                                        <div class="radio">
                                                            <label>
                                                ...
                                                <div class="form-group">
                                                    <label class="col-sm-5 control-label">บัญชีกิจการ</label>
                                                    <div class="col-sm-5">
                                                        <asp:DropDownList ID="CboAccNoPayCapital" runat="server" class="form-control"></asp:DropDownList>
                                                    </div>
                                                </div>
                                                <hr />
                                                <div class="form-group">
    ...
    <script type="text/javascript">
        ...
        function CFDateChange() {

            var CFLoanDate = document.getElementById('<%= dtCFDate.ClientID%>');
        ...
        function STCalDateChange() {
            var STCalDate = document.getElementById('<%= dtSTCalDate.ClientID%>');
            var STPayDate = document.getElementById('<%= dtSTPayDate.ClientID%>');

            if (STCalDate.value != "") {
                var parts = STCalDate.value.split('/')
                var paydate = new Date(parts[2] - 543, parts[1], parts[0]);
                paydate = paydate.add(0).month();
                STPayDate.value = $.datepicker.formatDate("dd/mm/yy", paydate);
                var parts2 = STPayDate.value.split('/');
