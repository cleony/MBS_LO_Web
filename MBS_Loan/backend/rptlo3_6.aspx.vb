...
Public Class rptlo3_6
    ...
    Protected Sub showreport(sender As Object, e As EventArgs)
        Session("formname") = "lorpt036"

        If ddlTypeLoan.SelectedIndex > 0 Then
            Session("lorpt036_TypeLoanId1") = ddlTypeLoan.SelectedValue.ToString
            Session("lorpt036_TypeLoanName1") = ddlTypeLoan.SelectedItem.Text
        Else
            Session("lorpt036_TypeLoanId1") = ""
            Session("lorpt036_TypeLoanName1") = "ทั้งหมด"
        End If


        'If ddlTypeLoan2.SelectedIndex > 0 Then
        '    Session("lorpt036_TypeLoanId2") = ddlTypeLoan2.SelectedValue.ToString
        '    Session("lorpt036_TypeLoanName2") = ddlTypeLoan2.SelectedItem.Text
        'Else
        '    Session("lorpt036_TypeLoanId2") = ""
        '    Session("lorpt036_TypeLoanName2") = "ทั้งหมด"
        'End If
        Session("lorpt036_AccountNo1") = txtAccountNo.Value
        Session("lorpt036_AccountNo2") = txtAccountNo2.Value
        Session("lorpt036_RptDate") = Share.FormatDate(dtRptDate.Value)
        ...
        Session("lorpt036_branchid") = BranchId
        Session("lorpt036_branchid2") = BranchId2
