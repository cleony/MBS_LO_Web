<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/backend/Site1.Master" CodeBehind="rptlo1_7.aspx.vb" Inherits="MBS_Loan.rptlo1_7" %>
        ...
        <section class="content">
            <div class="box box-default">
                <div class="box-header with-border">
                    <h3 class="box-title">1.7 รายงานการต่อสัญญาเงินกู้</h3>
                </div>
                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <select id="optDate" runat="server" class="custom-select form-control">
                                                ...
                                                <option>ช่วงวันที่ต่อสัญญา</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
