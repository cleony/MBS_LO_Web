<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/backend/Site1.Master" CodeBehind="rptlo3_2.aspx.vb" Inherits="MBS_Loan.rptlo3_2" %>
        ...
        <section class="content">
            <div class="box box-default">
                <div class="box-header with-border">
                    <h3 class="box-title">3.2 รายงานลูกหนี้คงเหลือ</h3>
                </div>
                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <select id="optReport" runat="server" class="custom-select form-control">
                                                <option>แจงตามลูกหนี้</option>
                                                <option>สรุปตามประเภทเงินกู้</option>
                                                <option>แจงตามดอกเบี้ยรายวัน</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
