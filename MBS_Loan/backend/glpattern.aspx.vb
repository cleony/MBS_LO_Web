...
Public Class glpattern
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not (IsPostBack) Then
                ...
                dt = Obj.GetAllGL_Pattern(Constant.Database.Connection1)
                Dim Html As String = ""
    ...
    Public Shared Function ConvertDataTableToHTML(ByVal dt As DataTable) As String
        ...
        html.Append("<table id='dtbank' class='table table-striped table-bordered no-wrap' >")
        html.Append("<thead>")

        html.Append("<tr>")

        html.Append("<th>ลำดับ</th>")
        html.Append("<th>รหัสรูปแบบ</th>")
        html.Append("<th>ชื่อรูปแบบ</th>")
        html.Append("<th>ประเภทรูปแบบ</th>")
    ...
    Protected Sub NewPrefix(sender As Object, e As EventArgs)
        Response.Redirect("glpatternsub.aspx")
    End Sub
End Class