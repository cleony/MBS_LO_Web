<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/backend/Site1.Master" CodeBehind="rptlo2_5.aspx.vb" Inherits="MBS_Loan.rptlo2_5" %>
        ...
        <section class="content">
            <div class="box box-default">
                <div class="box-header with-border">
                    <h3 class="box-title">2.5 รายงานสรุปการชำระเงินกู้ตามลูกค้า/สมาชิก</h3>
                </div>
                <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <select id="optReport" runat="server" class="custom-select form-control">
                                            <option>รูปแบบที่1</option>
                                            <option>รูปแบบที่2</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
