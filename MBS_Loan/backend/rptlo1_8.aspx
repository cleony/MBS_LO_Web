<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/backend/Site1.Master" CodeBehind="rptlo1_8.aspx.vb" Inherits="MBS_Loan.rptlo1_8" %>
        ...
        <section class="content">
            <div class="box box-default">
                <div class="box-header with-border">
                    <h3 class="box-title">1.8 รายงานการตัดหนี้สูญ</h3>
                </div>
                <div class="box-body">
