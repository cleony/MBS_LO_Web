...
Public Class rptlo2_6
    ...
    Protected Sub showreport(sender As Object, e As EventArgs)
        Session("formname") = "lorpt026"
        'Session("lorpt001_accountno") = txtAccountNo.Value
        If ddlTypeLoan.SelectedIndex > 0 Then
            Session("lorpt026_TypeLoanId1") = ddlTypeLoan.SelectedValue.ToString
            Session("lorpt026_TypeLoanName1") = ddlTypeLoan.SelectedItem.Text
        Else
            Session("lorpt026_TypeLoanId1") = ""
            Session("lorpt026_TypeLoanName1") = "ทั้งหมด"
        End If
        If ddlTypeLoan2.SelectedIndex > 0 Then
            Session("lorpt026_TypeLoanId2") = ddlTypeLoan2.SelectedValue.ToString
            Session("lorpt026_TypeLoanName2") = ddlTypeLoan2.SelectedItem.Text
        Else
            Session("lorpt026_TypeLoanId2") = ""
            Session("lorpt026_TypeLoanName2") = "ทั้งหมด"
        End If
        Session("lorpt026_StDate") = Share.FormatDate(dtStDate.Value)
        Session("lorpt026_EndDate") = Share.FormatDate(dtEndDate.Value)
        Session("lorpt026_PersonId1") = txtPersonId.Value
        Session("lorpt026_PersonId2") = txtPersonId2.Value
        Session("lorpt026_DividendRate") = txtDividendRate.Value
        ...
        Session("lorpt026_branchid") = BranchId
        Session("lorpt026_branchid2") = BranchId2
