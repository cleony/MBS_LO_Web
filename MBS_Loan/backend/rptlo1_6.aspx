<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/backend/Site1.Master" CodeBehind="rptlo1_6.aspx.vb" Inherits="MBS_Loan.rptlo1_6" %>
        ...
        <section class="content">
            <div class="box box-default">
                <div class="box-header with-border">
                    <h3 class="box-title">1.6 รายงานสัญญากู้เงินที่อนุมัติแล้ว</h3>
                </div>
                <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <select id="optReport" runat="server" class="custom-select form-control">
                                            <option>รูปแบบรายงาน</option>
                                            <option>รูปแบบฟอร์ม(อนุมัติโอนเงิน)</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label ">ฟอร์มอนุมัติโอนเงิน</label>
                                    <div class="col-sm-6">
