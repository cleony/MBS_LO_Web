...
Public Class rptlo2_2
    ...
    Protected Sub showreport(sender As Object, e As EventArgs)
        ...
        If ckSt8.Checked Then
            ...
            St &= "'8'"
        End If
        Session("lorpt022_St") = St
        Session("formname") = "lorpt022"
        If optReport.Value = "แบบละเอียด" Then
            Session("lorpt022_optReport") = "1"
        ElseIf optReport.Value = "แบบสรุป" Then
            Session("lorpt022_optReport") = "2"
        Else
            Session("lorpt022_optReport") = "3"
        End If
        If optDate.Value = "สรุปทั้งหมด" Then
            Session("lorpt022_optDate") = "1"
        ElseIf optDate.Value = "สรุปช่วงวันที่อนุมัติ" Then
            Session("lorpt022_optDate") = "2"
        End If
        If ddlTypeLoan.SelectedIndex > 0 Then
            Session("lorpt022_TypeLoanId1") = ddlTypeLoan.SelectedValue.ToString
            Session("lorpt022_TypeLoanName1") = ddlTypeLoan.SelectedItem.Text
        Else
            Session("lorpt022_TypeLoanId1") = ""
            Session("lorpt022_TypeLoanName1") = "ทั้งหมด"
        End If
        If ddlTypeLoan2.SelectedIndex > 0 Then
            Session("lorpt022_TypeLoanId2") = ddlTypeLoan2.SelectedValue.ToString
            Session("lorpt022_TypeLoanName2") = ddlTypeLoan2.SelectedItem.Text
        Else
            Session("lorpt022_TypeLoanId2") = ""
            Session("lorpt022_TypeLoanName2") = "ทั้งหมด"
        End If
        Session("lorpt022_AccountNo1") = txtAccountNo.Value
        Session("lorpt022_AccountNo2") = txtAccountNo2.Value
        Session("lorpt022_StDate") = Share.FormatDate(dtStDate.Value)
        Session("lorpt022_EndDate") = Share.FormatDate(dtEndDate.Value)
        If ddlUser.SelectedIndex > 0 Then
            Session("lorpt022_UserID1") = ddlUser.SelectedValue.ToString
        Else
            Session("lorpt022_UserID1") = ""
        End If
        If ddlUser2.SelectedIndex > 0 Then
            Session("lorpt022_UserID2") = ddlUser2.SelectedValue.ToString
        Else
            Session("lorpt022_UserID2") = ""
        End If
        ...
        Session("lorpt022_branchid") = BranchId
        Session("lorpt022_branchid2") = BranchId2
