...
Public Class rptlo1_8
    ...
    Protected Sub showreport(sender As Object, e As EventArgs)
        Session("formname") = "lorpt018"
        'Session("lorpt001_accountno") = txtAccountNo.Value
        If optDate.Value = "ณ วันที่" Then
            Session("lorpt018_optDate") = "1"
        ElseIf optDate.Value = "ช่วงวันที่ต่อสัญญา" Then
            Session("lorpt018_optDate") = "2"
        End If
        If ddlTypeLoan.SelectedIndex > 0 Then
            Session("lorpt018_TypeLoanId1") = ddlTypeLoan.SelectedValue.ToString
            Session("lorpt018_TypeLoanName1") = ddlTypeLoan.SelectedItem.Text
        Else
            Session("lorpt018_TypeLoanId1") = ""
            Session("lorpt018_TypeLoanName1") = "ทั้งหมด"
        End If
        If ddlTypeLoan2.SelectedIndex > 0 Then
            Session("lorpt018_TypeLoanId2") = ddlTypeLoan2.SelectedValue.ToString
            Session("lorpt018_TypeLoanName2") = ddlTypeLoan2.SelectedItem.Text
        Else
            Session("lorpt018_TypeLoanId2") = ""
            Session("lorpt018_TypeLoanName2") = "ทั้งหมด"
        End If
        Session("lorpt018_PersonId1") = txtPersonId.Value
        Session("lorpt018_StDate") = Share.FormatDate(dtStDate.Value)
        Session("lorpt018_EndDate") = Share.FormatDate(dtEndDate.Value)
        ...
        Session("lorpt018_branchid") = BranchId
        Session("lorpt018_branchid2") = BranchId2
