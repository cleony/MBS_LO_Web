Namespace Data
    ...
    Public Class DBCommand
        ...
        Private parameters() As OleDb.OleDbParameter
        ...
        Sub New(ByRef Conn As DBConnection, _
                ...
                Optional ByVal Parameters() As OleDb.OleDbParameter = Nothing)

            Me.sqlConn = Conn
            Me.spName = SPName
            Me.parameters = Parameters

            sqlCmd = New OleDb.OleDbCommand(SPName)
        ...
        Public Function ExecuteReader() As OleDb.OleDbDataReader
