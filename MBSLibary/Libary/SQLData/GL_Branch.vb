...
#End Region
        Public Function GetAllBranch() As DataTable
            ...
            Return dt
        End Function
        Public Function GetBranchById(ByVal Id As String) As Entity.gl_branchInfo
            Dim ds As New DataSet
            Dim Info As New Entity.gl_branchInfo
        ...
        Public Function GetBranchFromAccountChart() As Entity.gl_branchInfo()

            Dim cmd As SQLData.DBCommand
            Dim objbranchtype As Entity.gl_branchInfo
            Dim ListCom As New Collections.Generic.List(Of Entity.gl_branchInfo)
            Dim sql As String
            Dim ds As New DataSet
            ...
            Try
                ...
                If Not Share.IsNullOrEmptyObject(ds.Tables) And ds.Tables(0).Rows.Count > 0 Then
                    For Each dr As DataRow In ds.Tables(0).Rows
                        objbranchtype = New Entity.gl_branchInfo
                        With objbranchtype
        ...
        End Function
        Public Function GetTopBranch() As Entity.gl_branchInfo
            Dim ds As New DataSet
            Dim Info As New Entity.gl_branchInfo

            Try
                sql = "select * from CD_Branch where Status = 1 "
                cmd = New SQLData.DBCommand(sqlCon, sql, CommandType.Text)
                ds = New DataSet
                cmd.Fill(ds)
        ...
        Public Function DeleteBranchById(ByVal Id As String) As Boolean
            ...
            Return status
        End Function
        Public Function InsertBranch(ByVal Info As Entity.gl_branchInfo) As Boolean
            Dim status As Boolean
            ...
            Return status
        End Function
        Public Function UpdateBranch(ByVal oldId As String, ByVal Info As Entity.gl_branchInfo) As Boolean
            Dim status As Boolean
            Dim Sp As SqlClient.SqlParameter
            Dim ListSp As New Collections.Generic.List(Of SqlClient.SqlParameter)
